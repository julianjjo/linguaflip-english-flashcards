...
const QuickActions: React.FC<QuickActionsProps> = () => {
  const actions = [
    ...
    },
    {
      ...
      color: 'secondary',
      bgColor:
        'bg-secondary-50 hover:bg-secondary-100 dark:bg-secondary-900/20 dark:hover:bg-secondary-900/30',
    ...
    },
    {
      ...
      color: 'accent',
      bgColor:
        'bg-accent-50 hover:bg-accent-100 dark:bg-accent-900/20 dark:hover:bg-accent-900/30',

...
export const StatusMessage: React.FC<StatusMessageProps> = ({
  ...
  const getIcon = () => {
    ...
    switch (type) {
      case 'loading':
        return (
          <svg className={`animate-spin ${iconClasses} ${iconSize}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      case 'error':
        return (
          <svg className={iconClasses + ' ' + iconSize} viewBox="0 0 20 20" fill="currentColor">
